...
export default function Add_product() {
  ...
  return (
    <div className="bg-gray-100 min-h-screen flex flex-col">
      ...
      {/* Add Product Form */}
      <div className="flex-1 flex justify-center items-center py-8 px-4 md:px-0">
            ...
            <div className="flex flex-wrap -mx-2 md:-mx-4">
              <div className="w-full md:w-1/2 px-2 md:px-4 mb-4">
                ...
                <input id="name" type="text" name="itemName"
                  value={inputsdata.name} className="w-full py-2 px-3 bg-gray-100 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-indigo-500" placeholder="Enter item name" onChange={handleChange} />
              </div>
              <div className="w-full md:w-1/2 px-2 md:px-4 mb-4">
                ...
                <input id="model" type="text" name="itemModel"
                  value={inputsdata.model} className="w-full py-2 px-3 bg-gray-100 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-indigo-500" placeholder="Enter item model" onChange={handleChange} />
              </div>
              <div className="w-full md:w-1/2 px-2 md:px-4 mb-4">
                ...
                <input id="itemcode" type="text" name="itemCode"
                  className="w-full py-2 px-3 bg-gray-100 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-indigo-500" placeholder="Enter item code" onChange={handleChange}
                  value={inputsdata.itemcode} />
              </div>
              <div className="w-full md:w-1/2 px-2 md:px-4 mb-4">
                <label htmlFor="price" className="block text-sm font-medium text-gray-700 mb-1">Price</label>
                <input id="price" type="number" name="price" className="w-full py-2 px-3 bg-gray-100 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-indigo-500" placeholder="Enter price"
              ...
              <div className="w-full px-2 md:px-4 mb-4">
                ...
                <input id="stock" type="number" name="stock" className="w-full py-2 px-3 bg-gray-100 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-indigo-500" placeholder="Enter stock"
                  onChange={handleChange} value={inputsdata.stock} />
              </div>
            </div>
